  ...
  return (
    <div className="max-w-screen-xl mt-24 px-8 xl:px-16 mx-auto" id="about">
      ...
      <div className="relative w-full flex">
        <ScrollAnimationWrapper className="rounded-lg  w-full grid grid-flow-row sm:grid-flow-row grid-cols-1 sm:grid-cols-3 py-9 divide-y-2 sm:divide-y-0 sm:divide-x-2 divide-gray-200 bg-gray-100 z-10">
